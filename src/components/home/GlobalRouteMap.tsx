...
const ROUTES = [
  {
    code: '01',
    title: 'Los Angeles 海外仓',
    region: 'WEST COAST · USA',
    desc: '美西核心口岸，衔接快船卡派、海外仓与本土派送。',
    isCyan: true,
  },
  {
    code: '02',
